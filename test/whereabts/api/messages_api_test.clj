...
(def expected-res-for-new-anon-message (expected-res 201 new-anonymous-msg-payload))
...
(fact "should POST anonymous new message"
	...
	(provided 
		(save-new-message new-anonymous-msg-payload) => new-anonymous-msg-payload :times 1))